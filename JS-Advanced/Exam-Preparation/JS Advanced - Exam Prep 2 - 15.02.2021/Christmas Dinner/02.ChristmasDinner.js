class ChristmasDinner {
    ...
    shopping([product, price]) {//format will come as array with productType and price
    ...
    recipes({ recipeName, productsList }) {//format string and array of strings
    ...
    inviteGuests(name, dish) {//strings
